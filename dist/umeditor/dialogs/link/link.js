(function() {
  ...
  UM.registerWidget("link", {
    tpl:
      ...
      "</style>" +
      '<div class="edui-link-table">' +
      '<div class="edui-link-address">' +
      '<label for="href"><%=lang_input_url%></label>' +
      '<input class="edui-link-txt" id="edui-link-Jhref" type="text" />' +
      "</div>" +
      '<div class="edui-link-title">' +
      '<label for="title"><%=lang_input_title%></label>' +
      '<input class="edui-link-txt" id="edui-link-Jtitle" type="text"/>' +
      "</div>" +
      '<div class="edui-link-type">' +
